  ...
  return (
    <SetupCheck>
      <Routes>
        ...
        <Route path='/oauth/discord' element={<Suspense fallback={<Loading />}><OAuth2Callback type='discord' /></Suspense>} />
        <Route path='/oauth/oidc' element={<Suspense fallback={<Loading />}><OAuth2Callback type='oidc' /></Suspense>} />
        <Route path='/oauth/linuxdo' element={<Suspense fallback={<Loading />}><OAuth2Callback type='linuxdo' /></Suspense>} />
