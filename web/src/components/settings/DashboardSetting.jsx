...
const DashboardSetting = () => {
  ...
  return <>
      <Spin spinning={loading} size='large'>
        ...
        <Modal title={t('配置迁移确认')} visible={showMigrateModal} onOk={handleMigrate} onCancel={() => setShowMigrateModal(false)} confirmLoading={loading} okText={t('确认迁移')} cancelText={t('取消')}>
