...
export function Mermaid(props) {
  ...
  return <div className={clsx('mermaid-container')} style={{
    cursor: 'pointer',
    overflow: 'auto',
    padding: '12px',
...
function SandboxedHtmlPreview({
  ...
  return <iframe ref={iframeRef} sandbox='allow-same-origin' srcDoc={code} title='HTML Preview' style={{
    width: '100%',
...
export function PreCode(props) {
  ...
  return <>
      ...
      lineHeight: '1.4'
        ...
        <div className='copy-code-button' style={{
        position: 'absolute',
        top: '8px',
        right: '8px',
        display: 'flex',
        ...
        transition: 'opacity 0.2s ease'
          ...
          <Tooltip content={"复制代码"}>
            <Button size='small' theme='borderless' icon={<IconCopy />} onClick={e => {
            e.preventDefault();
            e.stopPropagation();
            if (ref.current) {
...
function CustomCode(props) {
  ...
  return <div style={{
    position: 'relative'
      ...
      <code className={clsx(props?.className)} ref={ref} style={{
...
function _MarkdownContent(props) {
  ...
  return <ReactMarkdown remarkPlugins={[RemarkMath, RemarkGfm, RemarkBreaks]} rehypePlugins={rehypePluginsBase} components={{
    pre: PreCode,
    code: CustomCode,
    p: pProps => <p {...pProps} dir='auto' style={{
      lineHeight: '1.6',
    ...
    a: aProps => {
      ...
      return <a {...aProps} target={target} style={{
...
export function MarkdownRenderer(props) {
  ...
  return <div className={clsx('markdown-body', className)} style={{
    ...
    ...style
      ...
      </div> : <MarkdownContent content={content} className={className} animated={animated} previousContentLength={previousContentLength} />}
    </div>;
}
